package com.qiyue.orm.jpa.utils;

import com.google.common.base.Splitter;
import com.qiyue.orm.jpa.utils.convert.Converters;
...
public class PredicateUtil {
    ...
    public static <Z, X> Predicate getOrPredicate(List<String> filters, CriteriaBuilder criteriaBuilder, From<Z, X> root) {
        ...
        if (orFilters.size() == 0) {
            ...
            return criteriaBuilder.and(filterToPredicates(orFilters.get(0), criteriaBuilder, root, stringJoinMap).<Predicate>toArray(new Predicate[]{}));
        } else {
